...
// Redbook working-copy toggle: expose Beav's existing profile save control so
// its canonical creator payload can reach the Redbook loopback connector.
const ACCOUNT_BINDING_FEATURE_ENABLED = true;
