...
import { WritingPageErrorBoundary, WritingSelectionPage } from './pages/WritingSelectionPage';
...
export function App() {
  ...
  else if (activePage === 'writing') content = <WritingPageErrorBoundary onNavigate={setActivePage}><WritingSelectionPage onNavigate={setActivePage} /></WritingPageErrorBoundary>;
